...
public class PushDispatcher {
    ...
    private static final String appId = "Z7SMaCQQjn8SwdVu42Sqy4";
    private static final String appKey = "OgbECWl1Ik8DEbCKPBNUA3";
    private static final String masterSecret = "a81NwQlugq5lmUgR5jRNsA";
